 ...
 * @param paperId
 */
export const loadPaperQuestion = async (examId: number, paperId: number) =>
    postApi('online_exam_service/examAnswer/v1/getExamPaper', {
        examId, paperId
    }, {});
 ...
 * @param paperId
 */
export const loadQuestionOptions = async (examId: number, paperId: number, questionIdArray: []) =>
    postApi('online_exam_service/examAnswer/v1/getExamPaperQuestionOptionsBatch', {}, {
        examId: examId,
        paperId: paperId,
...
export const answerQuestionBatchApi = async (examId: number, paperId: number, recordsId: number, answers: any[]) =>
    postApi('online_exam_service/examAnswer/v1/answerQuestionBatch', {}, {
        examId: examId,
        paperId: paperId,
        recordsId: recordsId,
        answers: answers
